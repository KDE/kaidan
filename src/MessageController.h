...
public:
	...
	QFuture<bool> retrieveBacklogMessages(const QString &jid,
		bool isGroupChat,
		const QString &oldestMessageStanzaId = QLatin1String(""));
...
private:
	 ...
	 */
	void retrieveInitialMessage(const QString &jid,
		bool isGroupChat,
		const QString &offsetMessageId = QLatin1String(""));
	...
	void updateLatestMessage(const QString &accountJid,
	...
	static std::optional<EncryptedSource>
	parseEncryptedSource(qint64 fileId, const QXmppEncryptedFileSource &source);
