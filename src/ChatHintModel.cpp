...
ChatHintModel::ChatHintModel(QObject *parent)
    ...
    , m_messageModel(MessageModel::instance())
{
    Q_ASSERT(!s_instance);
    s_instance = this;
...
void ChatHintModel::handleRosterItemPresenceSubscription()
{
    ...
    const auto subscriptionAllowed = subscription == QXmppRosterIq::Item::SubscriptionType::From || subscription == QXmppRosterIq::Item::SubscriptionType::Both;
