...
public:
	...
	{
		static const bool isMaterial =
			name().compare(QStringLiteral("Material"), Qt::CaseInsensitive) == 0;
		return isMaterial;
	}
	...
	{
		return name() == QStringLiteral("Material") ||
		       name() == QStringLiteral("org.kde.desktop");
	}
};
