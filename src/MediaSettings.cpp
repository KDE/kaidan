...
{
    return camera == other.camera && audioInputDevice == other.audioInputDevice && container == other.container;
}
...
CommonEncoderSettings::CommonEncoderSettings(const QString &codec, CommonEncoderSettings::EncodingQuality quality, const QVariantMap &options)
    : codec(codec)
    , quality(quality)
    , options(options)
{
...
ImageEncoderSettings::ImageEncoderSettings(const QImageEncoderSettings &settings)
    : CommonEncoderSettings(settings.codec(), static_cast<CommonEncoderSettings::EncodingQuality>(settings.quality()), settings.encodingOptions())
...
{
    return CommonEncoderSettings::operator==(other) && mode == other.mode && bitRate == other.bitRate && sampleRate == other.sampleRate
...
{
    return CommonEncoderSettings::operator==(other) && mode == other.mode && bitRate == other.bitRate && frameRate == other.frameRate
