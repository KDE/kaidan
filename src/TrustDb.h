...
public:
	...
	auto setSecurityPolicy(const QString &encryption, SecurityPolicy securityPolicy)
	...
	auto keys(const QString &encryption, QXmpp::TrustLevels trustLevels = {})
		-> QXmppTask<KeysByLevel> override;
	...
	QXmppTask<QHash<bool, QMultiHash<QString, QByteArray>>> keysForPostponedTrustDecisions(
